<?php
/**
 * Функции и методы только в camelCase
 */
class Harpoon_Sniffs_NamingConventions_ValidFunctionNameSniff extends Squiz_Sniffs_NamingConventions_ValidFunctionNameSniff
{
