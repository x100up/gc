<?php
class Harpoon_Sniffs_Classes_ClassDeclarationSniff implements PHP_CodeSniffer_Sniff {
	...
	public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
		...
		if ($braceLine !== $classLine) {
			$error = 'Opening brace of a %s must be on the line the definition';
		...
		$nextToken = $tokens[($curlyBrace + 1)];
		if ($nextToken['content'] !== $phpcsFile->eolChar) {
